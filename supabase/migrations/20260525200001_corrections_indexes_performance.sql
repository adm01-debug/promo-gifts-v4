...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_integration_creds_name
  ON integration_credentials(name);

-- quotes: 65k seq_scans (100%) — RLS + listagem por usuário/organização/status
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_quotes_user_org_status
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_color_variations_product_id
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_image_import_log_product_id
