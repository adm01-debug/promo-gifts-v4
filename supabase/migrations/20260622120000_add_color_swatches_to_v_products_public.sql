-- APLICADO 2026-06-22
-- Migração: color_swatches adicionado à v_products_public
-- Executação: apply_migration (DDL via Supabase MCP)
-- ============================================================
-- Razão: v_products_public não incluía color_swatches, causando
-- ausencia do campo na RPC get_catalog_bestseller_page e queries
-- que usam a view.
-- ============================================================
-- O CREATE OR REPLACE VIEW preserva grants e dependências.
-- A tabela products já tinha a coluna (migração anterior).
-- Após executar, NOTIFY pgrst foi disparado para reload do schema.
...
SELECT
    ...
    -- 2026-06-22: color_swatches adicionado (NOVA COLUNA)
    p.color_swatches
FROM products p
