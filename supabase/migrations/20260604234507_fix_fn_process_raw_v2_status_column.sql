...
COMMENT ON FUNCTION public.fn_process_raw_v2(uuid, integer, boolean) IS
    'v2.2 2026-06-04: corrige regressao da 232944 (coluna removida processed -> status); restaura template de nome completo (size_code/capacity_ml + colapso de separadores) e advisory lock anti-race. Mantem anti-zumbi (early-return) e FOR UPDATE SKIP LOCKED.';
