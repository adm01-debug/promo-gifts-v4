-- ============================================================
-- Correção 🟠: restaurar a normalização de nome (clean_spot_name)
-- A função legada aplicava clean_spot_name(Name) ao nome do produto.
-- Evidência: 1200/1200 produtos atuais estão em "sentence-case"
-- (1ª letra maiúscula, restante minúsculo, espaços colapsados).
-- Recriamos isso como fn_clean_spot_name e ligamos via transform 'custom'.
-- ============================================================
