-- ============================================================
-- Correção 🔴: race condition entre 2 cron jobs (*/5) no SPOT
-- gerava ~56k batches vazios. Solução:
--  1) advisory xact lock por fornecedor em fn_process_raw_v2
...
SELECT cron.unschedule('process-marked-products');