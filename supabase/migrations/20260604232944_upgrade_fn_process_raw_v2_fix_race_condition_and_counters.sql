...
BEGIN
    ...
    -- Contar pendentes ANTES de abrir batch (anti-zumbi)
    ...
    -- Só abre batch se houver linhas pendentes reais
    IF v_pending_count > 0 THEN
        ...
        v_batch_open := true;
    ELSE
        -- Nada a processar — retorna imediatamente sem criar batch
    ...
    LOOP
      BEGIN
        ...
        -- 3) Variantes — com FOR UPDATE SKIP LOCKED para evitar race condition
        FOR v_row IN
        ...
        LOOP
          BEGIN
            ...
            -- Carimba raw com product_id, variant_id e batch
...
'Pipeline raw→products v2.1 — corrige: race condition (FOR UPDATE SKIP LOCKED), anti-zumbi (early return se 0 pendentes), source=raw_v2 no vss update';
