...
-- Upgrade fn_apply_transform (6-arg) para incluir transforms que existiam no apply_transform legado
-- Adiciona: suffix, uppercase, lowercase, trim, replace, regex_extract
...
BEGIN
    ...
    CASE p_transform_type
        ...
        -- ========== TRANSFORMS RESTAURADAS DO LEGADO ==========
...
'Transform pipeline v2.1 — inclui todas as transforms do legado: direct, multiply, divide, convert_unit, lookup, custom, prefix, suffix, uppercase, lowercase, trim, replace, regex_extract';
