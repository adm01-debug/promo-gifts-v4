...
-- Correção do bug de extração: source_path pode vir em sintaxe JSONPath ('$.Campo').
-- Limpa o prefixo '$.' e navega: aninhado→#>>, simples→->>. Fallback source_field.
