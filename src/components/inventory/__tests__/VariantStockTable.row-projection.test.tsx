...
const v = (id: string, color: string, stock: number): VariantStock => ({
  id, productId: "p1", variantId: id, variantSku: id,
  colorName: color, colorHex: "#000",
  currentStock: stock, minStock: 10, reservedStock: 0, inTransitStock: 0,
  availableStock: stock, status: "in_stock", updatedAt: "2026-01-01",
});

const product: ProductStockSummary = {
  productId: "p1", productName: "Caneta Multi", productSku: "CAN-001",
  categoryName: "Canetas", supplierName: "F",
  overallStatus: "in_stock",
  variantsInStock: 3, variantsLowStock: 0, variantsCritical: 0, variantsOutOfStock: 0,
  availableColors: [
    { colorName: "Azul", colorHex: "#00f", count: 1, totalStock: 500, availableStock: 500, status: "in_stock" } as never,
    { colorName: "Verde", colorHex: "#0f0", count: 1, totalStock: 300, availableStock: 300, status: "in_stock" } as never,
    { colorName: "Vermelho", colorHex: "#f00", count: 1, totalStock: 200, availableStock: 200, status: "in_stock" } as never,
  ],
  totalVariants: 3,
  totalCurrentStock: 1000, totalMinStock: 30, totalReservedStock: 0,
  totalInTransitStock: 0, totalAvailableStock: 1000,
