      ...
      >
        ...
        <aside
          ...
          <div className="hidden lg:flex items-center justify-between px-3 mt-4 mb-3 gap-2">
            ...
            >
              {/* Brand Header */}
              <div className="group/brand relative mb-2 border-b border-white/5 bg-gradient-to-b from-white/[0.04] to-transparent">
                <SidebarBrandHeader isCollapsed={isCollapsed} />
              ...
              <div className="mb-2 hidden items-center justify-between px-3 lg:flex">
                {!isCollapsed && hasAnyGroupOpen && (
                  <Button
                    variant="outline"
                    size="sm"
                    className="h-8 gap-2 rounded-xl border-sidebar-border/30 text-[10px] text-sidebar-foreground/40 transition-all duration-300 hover:bg-primary/10 hover:text-primary focus-visible:ring-1 focus-visible:ring-primary focus-visible:ring-offset-1"
                    onClick={collapseAllGroups}
                    aria-label="Recolher todos os grupos de navegação"
                  >
                    <X className="h-3 w-3" />
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="ml-auto h-8 w-8 rounded-xl text-sidebar-foreground/30 transition-all duration-300 hover:bg-sidebar-accent/50 hover:text-primary focus-visible:ring-1 focus-visible:ring-primary"
                  onClick={toggleCollapse}
                  aria-label={isCollapsed ? 'Expandir menu' : 'Recolher menu'}
                  title={isCollapsed ? 'Expandir menu' : 'Recolher menu'}
                >
