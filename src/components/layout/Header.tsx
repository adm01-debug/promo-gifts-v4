  ...
  return (
    <header
      ...
      className={cn(
        ...
        'h-[var(--header-h)]',
        isScrolled && 'border-border/50 bg-card/60 shadow-lg backdrop-blur-2xl',
      )}
    >
      <div className="flex h-full items-center justify-between px-2 sm:px-4 lg:px-6">
        ...
        <div className="flex min-w-0 shrink-0 items-center gap-2 sm:gap-3">
          ...
          <div className="hidden items-center gap-4 lg:flex">
            <span className="max-w-[120px] truncate font-display text-sm font-bold uppercase tracking-wider text-primary drop-shadow-[0_0_8px_rgba(var(--primary),0.5)]">
              {currentSection}
            </span>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                className="flex h-9 items-center gap-2 rounded-lg px-1.5 hover:bg-primary/10 sm:px-2"
              >
                <div className="relative">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-primary shadow-md ring-2 ring-background">
                    {profile?.avatar_url ? (
                      <img
