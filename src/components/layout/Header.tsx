...
interface HeaderProps {
  ...
  /** Estado atual do sidebar para refletir em aria-expanded / aria-label. */
  sidebarOpen?: boolean;
}
...
export const Header = React.memo(function Header({
  ...
  // `getRoleLabel(role)` ainda é exportado pelo módulo de auth para outros
  // consumidores; mantido localmente comentado caso a UI volte a expor.
  void getRoleLabel;
