      ...
      <div
        className={cn(
          ...
          !iconClassName?.includes('h-') && (
            isSidebar 
              ? 'h-7 w-7 2xl:h-7.5 2xl:w-7.5 ultra-wide:h-8 ultra-wide:w-8' 
        ...
        <div className="flex flex-col">
          <span
            className={cn(
              ...
              isSidebar 
                ? 'text-[13px] sm:text-sm 2xl:text-[15px] ultra-wide:text-base' 
                : 'text-[22px] sm:text-[34.8px] tracking-[0.08em]',
              textClassName,
            )}
          >
            PROMO BRINDES
          ...
          <span
            className={cn(
              ...
              isSidebar 
                ? 'mt-0.5 text-[8px] 2xl:text-[9px] uppercase tracking-[0.1em]' 
                : 'mt-1.5 text-[9px] sm:text-[13.2px] tracking-[0.3em] sm:tracking-[0.35em] text-primary/90',
              subtextClassName,
            )}
          >
