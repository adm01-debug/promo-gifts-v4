      ...
      const linkContent = (
        <NavLink
          ...
          className={cn(
            ...
            'hover:translate-x-1 hover:bg-white/[0.03]',
            isActive
              ? 'bg-primary/10 font-bold text-white shadow-[0_0_15px_rgba(var(--primary),0.05)] before:absolute before:bottom-[15%] before:left-0 before:top-[15%] before:w-[3px] before:rounded-r-full before:bg-primary'
              : 'text-sidebar-foreground/70 before:absolute before:left-0 before:top-1/2 before:h-0 before:w-[2px] before:-translate-y-1/2 before:rounded-r-full before:bg-primary/50 before:transition-all before:duration-300 hover:text-sidebar-foreground hover:before:h-4',
          )}
        ...
        >
          <Icon
            className={cn(
              ...
              isActive
                ? 'scale-110 text-primary drop-shadow-[0_0_8px_rgba(var(--primary),0.8)]'
      ...
      <Collapsible open={isOpen} onOpenChange={onToggle}>
        <CollapsibleTrigger asChild>
          <button
            ...
            className={cn(
              'flex w-full items-center gap-3 rounded-lg px-3 py-2 transition-all duration-150 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-orange/15 active:scale-[0.995]',
              'text-sidebar-foreground/70 hover:bg-sidebar-accent/50 hover:text-sidebar-foreground',
              hasActiveItem && 'bg-primary/[0.05] text-primary',
            )}
          >
            <GroupIcon
              className={cn(
