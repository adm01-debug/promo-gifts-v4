      ...
      >
        ...
        <div className="border-t border-border/40 bg-muted/30 px-3 py-2">
          ...
          <div className="mt-1.5 flex gap-1.5">
            <HalfBar value={summary.firstHalfTotal} max={Math.max(summary.firstHalfTotal, summary.secondHalfTotal)} muted />
            <HalfBar value={summary.secondHalfTotal} max={Math.max(summary.firstHalfTotal, summary.secondHalfTotal)} />
          </div>
        </div>
