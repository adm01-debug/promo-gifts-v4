...
export function ProductList({
  ...
  const displayProducts: (Product | SkeletonItem)[] =
      ...
      <div className="flex flex-col gap-2">
        {displayProducts.map((product, index) => {
          if ('isSkeleton' in product && product.isSkeleton) {
            return <ProductCardSkeleton key={product.id} variant={skeletonVariant} />;
          }
          // TypeScript doesn't narrow union in ternary false-branch; cast explicitly
