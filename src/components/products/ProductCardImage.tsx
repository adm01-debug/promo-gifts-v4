...
interface ProductCardImageProps {
  ...
  cardImageUrl: string;
  /** URL de fallback para imagem do card (url_original do produto primário). */
  cardImageFallbackUrl?: string | null;
  cardSrcSet?: string;
...
export const ProductCardImage = memo(function ProductCardImage({
  product, cardImageUrl, cardSrcSet, cardImageFallbackUrl, activeColorName, colorSpecificImage,
  ...
  return (
    ...
    >
      {/* Image — CF primary, fallback: prop explícita > derivação SPOT > null */}
      <OptimizedImage
        src={cardImageUrl}
        ...
        urlOriginal={cardImageFallbackUrl ?? deriveOriginalUrl(cardImageUrl)}
        priority={priority}
      />
