            ...
            <TableBody>
              ...
              {showRow('publico') && (
                <SimpleRow
                  ...
                  render={(p) => (
                    <div className="flex flex-wrap justify-center gap-1">
                      {((p.tags?.publicoAlvo as string[] | undefined) ?? [])
                        .slice(0, 3)
                        .map((t: string) => (
              ...
              {showRow('datas') && (
                <SimpleRow
                  ...
                  products={products}
                  render={(p) =>
                    ((p.tags?.datasComemorativas as string[] | undefined) ?? []).length > 0 ? (
                      <div className="flex flex-wrap justify-center gap-1">
                        {(p.tags?.datasComemorativas as string[]).slice(0, 2).map((d: string) => (
