  ...
  return (
    <>
      ...
      <CommandDialog
        ...
        contentClassName="top-[12%] max-w-[760px] translate-y-0 border border-[hsl(var(--command-border))] !rounded-xl bg-[hsl(var(--command-surface))] shadow-[0_36px_120px_hsl(var(--command-shadow)),0_0_0_1px_hsl(var(--command-border-strong))] data-[state=open]:slide-in-from-top-6 data-[state=closed]:slide-out-to-top-6"
      >
