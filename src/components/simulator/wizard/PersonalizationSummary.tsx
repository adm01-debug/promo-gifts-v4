                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="min-w-0 flex-1 space-y-1 pt-0.5">
                                ...
                                <AlertDialogDescription className="text-xs leading-relaxed text-muted-foreground">
                                  Todas as <strong className="text-foreground">{personalizations.length} gravações</strong> serão removidas. Você precisará configurá-las novamente se quiser adicioná-las de volta.
                                </AlertDialogDescription>
                              </div>
                            </div>
                          </AlertDialogHeader>
