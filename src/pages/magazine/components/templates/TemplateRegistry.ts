...
export const TEMPLATE_REGISTRY: Record<MagazineTemplateId, TemplateEntry> = {
  ...
  'catalog-grid-2x3': {
    ...
    defaultColors: { primary: '#0f172a', secondary: '#0ea5e9', text: '#0f172a' },
  ...
  'catalog-grid-3x3': {
    ...
    productsPerPage: 9,
    fonts: { heading: 'Outfit', body: 'Outfit' },
    defaultColors: { primary: '#0f172a', secondary: '#16a34a', text: '#0f172a' },
  ...
  'catalog-list': {
    ...
    productsPerPage: 5,
    fonts: { heading: 'Outfit', body: 'Outfit' },
    defaultColors: { primary: '#111827', secondary: '#6366f1', text: '#111827' },
