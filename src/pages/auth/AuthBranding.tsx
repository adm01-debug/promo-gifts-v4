  ...
  return (
    <div className="relative flex min-h-screen w-full items-center lg:w-1/2">
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center px-12 lg:translate-x-[5%] xl:translate-x-[10%] xl:px-20"
      >
        <div className="flex w-full max-w-xl flex-col items-center space-y-6 text-center">
          ...
          <div className="flex max-w-lg flex-col items-center space-y-5">
            <motion.h2
              ...
              className="group relative text-center font-display text-4xl font-bold leading-[1.05] tracking-tight text-white xl:text-5xl"
            >
            ...
            <motion.p
              ...
              className="max-w-md text-center text-[0.95rem] font-light leading-relaxed text-white/60"
            >
