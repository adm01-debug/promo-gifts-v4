...
const log = createClientLogger('hooks.useQuoteTemplates');
...
export function useQuoteTemplates() {
  ...
  const fetchTemplates = useCallback(async () => {
    ...
    try {
      ...
      log.error('fetch_templates_failed', { err });
  ...
  const fetchAllTemplates = useCallback(async () => {
    ...
    try {
      ...
      log.error('fetch_all_templates_failed', { err });
    }
  }, [user, isAdmin]);
  ...
  const fetchSellers = useCallback(async () => {
    ...
    try {
      ...
      log.error('fetch_sellers_failed', { err });
    }
  }, [user, isAdmin]);
  ...
  const createTemplate = useCallback(
    async (input: CreateTemplateInput) => {
      ...
      try {
        ...
        log.error('create_template_failed', { err });
        toast({
          title: 'Erro',
  ...
  const updateTemplate = useCallback(
    async (id: string, updates: Partial<CreateTemplateInput>) => {
      ...
      try {
        ...
        log.error('update_template_failed', { err });
        toast({
          title: 'Erro',
  ...
  const deleteTemplate = useCallback(
    async (id: string) => {
      ...
      try {
        ...
        log.error('delete_template_failed', { err });
        toast({
          title: 'Erro',
  ...
  const cloneTemplateToSeller = useCallback(
    async (templateId: string, targetSellerId: string) => {
      ...
      try {
        ...
        log.error('clone_template_failed', { err });
        toast({
          title: 'Erro',
