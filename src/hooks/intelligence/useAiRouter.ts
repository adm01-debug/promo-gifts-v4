...
export function useAiProviderMutations() {
  ...
  const createProvider = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao criar provider', { description: sanitizeMessage(e) }),
  });
  ...
  const updateProvider = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao atualizar provider', { description: sanitizeMessage(e) }),
  });
  ...
  const deleteProvider = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao remover provider', { description: sanitizeMessage(e) }),
  });
...
export function useAiModelMutations() {
  ...
  const createModel = useMutation({
    ...
    onError: (e: Error) => toast.error('Erro ao criar modelo', { description: sanitizeMessage(e) }),
  });
  ...
  const updateModel = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao atualizar modelo', { description: sanitizeMessage(e) }),
  });
  ...
  const deleteModel = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao remover modelo', { description: sanitizeMessage(e) }),
  });
...
export function useAiRoutingMutations() {
  ...
  const createRouting = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao criar roteamento', { description: sanitizeMessage(e) }),
  });
  ...
  const updateRouting = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao atualizar roteamento', { description: sanitizeMessage(e) }),
  });
  ...
  const deleteRouting = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao remover roteamento', { description: sanitizeMessage(e) }),
  });
