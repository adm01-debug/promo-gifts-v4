...
export function useFavoriteLists() {
  ...
  const createList = useMutation({
    ...
    onError: (e: Error) => toast.error('Erro ao criar lista', { description: sanitizeMessage(e) }),
  });
  ...
  const updateList = useMutation({
    ...
    onError: (e: Error) =>
      toast.error('Erro ao atualizar lista', { description: sanitizeMessage(e) }),
  });
  ...
  const deleteList = useMutation({
    ...
    onError: (e: Error) => toast.error(sanitizeMessage(e)),
  });
...
export function useFavoriteListItems(listId: string | null) {
  ...
  const addItem = useMutation({
    ...
    onError: (e: Error) => toast.error('Erro ao salvar', { description: sanitizeMessage(e) }),
  });
  ...
  const moveItem = useMutation({
    ...
    onError: (e: Error) => toast.error('Erro ao mover', { description: sanitizeMessage(e) }),
  });
