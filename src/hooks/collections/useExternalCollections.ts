...
export function useExternalCollectionMutations() {
  ...
  const createCollection = useMutation({
    ...
    onError: (error) => {
      toast.error('Erro ao criar coleção', { description: sanitizeMessage(error) });
    },
  });
  ...
  const updateCollection = useMutation({
    ...
    onError: (error) => {
      toast.error('Erro ao atualizar', { description: sanitizeMessage(error) });
    },
  });
  ...
  const deleteCollection = useMutation({
    ...
    onError: (error) => {
      toast.error('Erro ao excluir', { description: sanitizeMessage(error) });
    },
  });
  ...
  const addProductToCollection = useMutation({
    ...
    onError: (error) => {
      toast.error('Erro', { description: sanitizeMessage(error) });
    },
  });
