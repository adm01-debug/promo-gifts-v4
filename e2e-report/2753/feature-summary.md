...
|---|---:|---:|---:|
| `uncategorized` | 1 | 44 | 39.9s |

### `uncategorized` — 1 failed
- **flows/22-google-oauth-smoke.spec.ts › @smoke Google OAuth — wiring até /auth/callback › /auth/callback com ?error= mostra hint detalhado e código do erro**  
  `flows/22-google-oauth-smoke.spec.ts:175`
