...
- **Run started:** 2026-06-11 14:37
- **Wall time:** 43.5s
- **Projects:** chromium-smoke
- **Totals:** 44 total · ✅ 3 · ❌ 1 · ⏭ 40

## Failures by feature

| Feature | Failed | Total | Duration |
|---|---:|---:|---:|
| `uncategorized` | 1 | 44 | 37.4s |

### `uncategorized` — 1 failed
- **flows/20-all-features-smoke.spec.ts › @smoke Rotas públicas (gate de CI) › 95 · /reset-password sem token não habilita reset**  
  `flows/20-all-features-smoke.spec.ts:355`
