...
- **Run started:** 2026-06-23 16:26
- **Wall time:** 150.5s
- **Projects:** chromium-smoke
- **Totals:** 52 total · ✅ 6 · ❌ 1 · ⏭ 45

## Failures by feature

| Feature | Failed | Total | Duration |
|---|---:|---:|---:|
| `uncategorized` | 1 | 52 | 143.8s |

### `uncategorized` — 1 failed
- **flows/25-password-reset-smoke.spec.ts › Fluxo: Password Reset UI › renderiza formulário quando há token no hash**  
  `flows/25-password-reset-smoke.spec.ts:15`
